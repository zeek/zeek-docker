...
terminal console:
    ...
    Successfully tagged broplatform/bro:4.1.1
    touch build-stamp_4.1.1
    $
...
is available in your local docker registry:
    ...
    broplatform/bro  4.1.1 5bc774250a9a 8 minutes ago  215MB
...
interactive bash shell:
    ...
    $ docker run -it -v `pwd`:/pcap broplatform/bro:4.1.1 /bin/bash
